...
urlpatterns = [
    ...
    path('activities/<int:pk>/toggle/', views.toggle_activity_status, name='toggle_activity_status'),
    ...
    path('contribution/<int:pk>/receipt/', views.download_receipt, name='download_receipt'),
    path('contributions/export/', views.export_contributions_csv, name='export_contributions_csv'),
]